...
<title>Clientes</title>
    ...
    <center><font class="w3-opacity" size="15%" style="color:red;"> <span class="detallefactura">Clientes</span></font> 
    </center></legend><br>
    </head>
            ...
            <div class="pure-u-1-12">
              <div align="center">
                ...
                <form action="?action=<?php echo $alm->Id > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                    ...
                    <td width="123"><button type="submit" class="w3-btn w3-red w3-round-xxlarge">Guardar</button> <button align="center" type="submit" onclick="location.href='principalA.html'" class="w3-btn w3-red w3-round-xxlarge">volver</button></td>
                </form>

                <table class="pure-table pure-table-horizontal">
                    <thead>
                        <tr>
                            <th width="14%" style="text-align:left;">Nombre</th>
                            <th width="15%" style="text-align:left;">Apellidos</th>
                            <th width="11%" style="text-align:left;">Genero</th>
                            
                            <th width="13%" style="text-align:left;">Ciudad</th>
                            <th width="14%" style="text-align:left;">Teléfono</th>
                            <th width="12%"></th>
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td>
                                <a class="w3-btn w3-gray w3-round-xxlarge" href="?action=editar&Id=<?php echo $r->Id; ?>">Editar</a>
