...
<html lang="es">
	<head>
     ...
     <fieldset><legend><strong><center><font size="5%">Formulario de Tipo de Documento</font></center></strong></legend>
                ...
                <table class="pure-table pure-table-horizontal">
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td>
                                <a href="?action=editar&idtd=<?php echo $r->idtd; ?>">Editar</a>
                            </td>
                            <td>
                                <a href="?action=eliminar&idtd=<?php echo $r->idtd; ?>">Eliminar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>     
