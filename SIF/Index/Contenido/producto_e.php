...
<title>Productos</title>
    ...
    <center><font class="w3-opacity" size="15%" style="color:red;"> <span class="detallefactura">Registrar pedidos</span></font> 
    </center></legend><br>
    </head>
              ...
              <div align="center">
                <form action="?action=<?php echo $alm->idproducto > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                    ...
                    <table width="87%" border="0">
                     ...
                     <td width="123"><button type="submit" class="w3-btn w3-red w3-round-xxlarge">Guardar</button> <button align="center" type="submit" onclick="location.href='principalE.html'" class="w3-btn w3-red w3-round-xxlarge">volver</button></td><hr><br>
                ...
                <table width="515" class="pure-table pure-table-horizontal">
                    <thead>
                        <tr>
                            <th width="173" style="text-align:left;">Nombre</th>
                            <th width="178" style="text-align:left;">Precio unitario</th>
                            <th width="135" style="text-align:left;">Cantidad</th>
                            <th width="68" style="text-align:left;">Total</th>
