				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="categoria.php" class="logo"><strong>Administrador</a></strong>
        ...
        <table width="87%" border="0" align="center" class="w3-table w3-RED">
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <a  class="w3-btn w3-gray w3-round-xxlarge"  href="?action=editar&idcategoria=<?php echo $r->idcategoria; ?>">Editar  </a> </button>
                            <a   class="w3-btn w3-red w3-round-xxlarge"  href="?action=eliminar&idcategoria=	<?php echo $r->idcategoria; ?>">Eliminar</a>
                            </thead></td>
                        </tr>
                    <?php endforeach; ?>
