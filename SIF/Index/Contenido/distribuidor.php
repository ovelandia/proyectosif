...
<title>Distribuidor</title>
    ...
    <center>
      <font class="w3-opacity" size="15%" style="color:red;"> <span class="detallefactura">Distribuidores</span></font> 
    </center></legend><br>
    </head>
    ...
    <div class="pure-u-1-12">
      <form action="?action=<?php echo $alm->iddistribuidor > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                ...
                <table class="pure-table pure-table-horizontal">
                    <thead>
                        <tr>
                            <th width="12%" style="text-align:left;">Nombre</th>
                            <th width="13%" style="text-align:left;">Telefono</th>
                            <th width="15%" style="text-align:left;">Direccion</th>
                            <th width="8%" style="text-align:left;">NIT</th>
                            <th width="34%"></th>
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td>
                                <a class="w3-btn w3-gray w3-round-xxlarge" href="?action=editar&iddistribuidor=<?php echo $r->iddistribuidor; ?>">Editar</a>
