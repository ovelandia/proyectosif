	...
	switch($_REQUEST['action'])
	{
		case 'actualizar':
            ...
            $alm->__SET('cantidad_insumos',         $_REQUEST['cantidad_insumos']);
             $alm->__SET('Quedan',         $_REQUEST['Quedan']);
...
<title>Insumos</title>
    ...
    <center><font class="w3-opacity" size="15%" style="color:red;"> <span class="detallefactura">Registrar Insumos</span></font> 
    </center></legend><br>
    </head>
                ...
                <form action="?action=<?php echo $alm->idinsumos > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                  ...
                  <table width="87%" border="0">
                    ...
                    <tr>
                        ...
                        <tr>
                            <th style="text-align:left;">Quedan:</th>
                            <td><input type="text" autocomplete="off" name="Quedan" placeholder="Quedan" required value="<?php echo $alm->__GET('Quedan'); ?>" style="width:100%;" /></td>
                        </tr>
                  ...
                  <td width="123"><button type="submit" class="w3-btn w3-red w3-round-xxlarge">Agregar</button> <button align="center" type="submit" onclick="location.href='principalE.html'" class="w3-btn w3-red w3-round-xxlarge">volver</button></td><br><br>
                </form>
                <center><font class="w3-opacity" size="15%" style="color:red;"> <span class="detallefactura">Lista Insumos</span></font> 
                </center><br><br>

                <table class="pure-table pure-table-horizontal">
                   
                        <tr>
                            <th width="19%" style="text-align:left;">insumo</th>
                            <th width="18%" style="text-align:left;">cantidad Insumos</th>
                             <th width="18%" style="text-align:left;">Quedan</th>
                            <th width="17%" style="text-align:left;">Medida</th>
                            <th width="17%" style="text-align:left;">Categoria</th>
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td><?php echo $r->__GET('Quedan'); ?></td>
                            <td><?php echo $r->__GET('medida'); ?></td>
                            <td><?php echo $r->__GET('nombre'); ?></td>
                            
                            
                            <td width="9%"><a class="w3-btn w3-blue w3-round-xxlarge" href="?action=editar&idinsumos=<?php echo $r->idinsumos; ?>">Editar</a> 
