...
if(isset($_REQUEST['action']))
{
	switch($_REQUEST['action'])
	{
		case 'actualizar':
			...
			$alm->__SET('desc_doc',     $_REQUEST['desc_doc']);
        ...
        <div class="pure-g">
            <div class="pure-u-1-12">
              <div align="center">
                ...
                <form action="?action=<?php echo $alm->idtipodocumento > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                    ...
                    <table width="87%" border="0">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="desc_doc" placeholder="Documento Cliente" required value="<?php echo $alm->__GET('desc_doc'); ?>" style="width:100%;" /></td>
                        </tr>
                ...
                <table class="pure-table pure-table-horizontal">
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td><?php echo $r->__GET('desc_doc'); ?></td>
                            <td>&nbsp;</td>
                            <td>
                                <a href="?action=editar&idtipodocumento=<?php echo $r->idtipodocumento; ?>"></a>
                        
                                <a  class="w3-btn w3-round-xxlarge" href="?action=editar&idtipodocumento=<?php echo $r->idtipodocumento; ?>">Editar</a> 
                                <a class="w3-btn w3-round-xxlarge" href="?action=eliminar&idtipodocumento=<?php echo $r->idtipodocumento; ?>">Eliminar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>     
