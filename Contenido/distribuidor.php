...
<title>Distribuidor</title>
                ...
                <!-- Main -->
                    <div id="main">
                        <div class="inner">
                            ...
                            <!-- Header -->
                                <header id="header">
                                    <a href="distribuidor.php" class="logo"><strong>Modo Administrador</a></strong>
    ...
    <center>
      <font class="w3-opacity" size="15%" style="color:red;"> <span class="detallefactura">Registrar Distribuidores </span></font> 
    </center></legend><br>
    </head>
    ...
    <div class="pure-u-1-12">
      <form action="?action=<?php echo $alm->iddistribuidor > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                 ...
                 <center>  <td width="123"><button type="submit" class="w3-btn w3-red w3-round-xxlarge">Agregar</button> <button align="center" type="submit" onclick="location.href='principalA.html'" class="w3-btn w3-red w3-round-xxlarge">volver</button></td><hr><br><center><center><center></center></center></center></center>
      ...
      <font class="w3-opacity" size="15%" style="color:red;"> <span class="detallefactura">Lista Distribuidores </span></font> 
                ...
                <table class="pure-table pure-table-horizontal">
                    <thead>
                        <tr>
                            <th width="21%" style="text-align:left;">Nombre</th>
                            <th width="20%" style="text-align:left;">Telefono</th>
                            <th width="22%" style="text-align:left;">Direccion</th>
                            <th width="14%" style="text-align:left;">NIT</th>
                            <th width="5%"></th>
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td>
                                <a class="w3-btn w3-blue w3-round-xxlarge" href="?action=editar&iddistribuidor=<?php echo $r->iddistribuidor; ?>">Editar</a>
                            
                                <a class="w3-btn w3-red w3-round-xxlarge" href="?action=eliminar&iddistribuidor=<?php echo $r->iddistribuidor; ?>">Eliminar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>     
