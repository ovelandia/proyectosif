                ...
                <table class="pure-table pure-table-horizontal">
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td>
                                <a class="w3-btn w3-round-xxlarge" href="?action=editar&iddetalle_factura=<?php echo $r->iddetalle_factura; ?>">Editar</a>
                            
                                <a class="w3-btn w3-round-xxlarge"  href="?action=eliminar&iddetalle_factura=<?php echo $r->iddetalle_factura; ?>">Eliminar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>     
