            ...
            <div class="pure-u-1-12">
              <div align="center">
                <form action="?action=<?php echo $alm->idinsumos > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" style="margin-bottom:30px;">
                  ...
                  <td width="123"><button type="submit" class="w3-btn w3-red w3-round-xxlarge">Agregar</button> <button align="center" type="submit" onclick="location.href='principalA.html'" class="w3-btn w3-red w3-round-xxlarge">volver</button></td><br><br>
                </form>
                ...
                <table class="pure-table pure-table-horizontal">
                        ...
                        <tr>
                            ...
                            <th width="18%" style="text-align:left;">Cantidad Insumos</th>
                             <th width="15%" style="text-align:left;">Quedan</th>
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td width="14%"><a class="w3-btn w3-blue w3-round-xxlarge" href="?action=editar&idinsumos=<?php echo $r-> 				 								idinsumos; ?>">Editar</a> 
